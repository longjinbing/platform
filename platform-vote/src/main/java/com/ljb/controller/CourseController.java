...
@Desc(group="教务管理中心",name="课程管理",type=1,url="vote/course.html")
public class CourseController extends BaseController {
     ...
     */
    @RequestMapping("/list")
    @Desc(name="课程列表",type=2,level = 0)
    public R list(@RequestParam Map<String, Object> params) {
        //查询列表数据
        return R.ok().put("data", courseService.selectList(params));
    }
