		...
		methods : {
			...
			editForm : function() {
				...
				if (id != '') {
					var url=transUrl("/courseteacher/");
					$.get(url+ id, function (r) {
						if(check(r)){
						vue.courseTeacher=r.data;
						clearVailator();
						openForm("修改信息");
						}
				    });
			...
			details:function(){
				var id = getSelectedRow();
				if (id != '') {
					var url = transUrl("/courseteacher/details/")+id;
					$.get(url, function(r) {
						if (check(r)) {
							vue.courseTeacher= r.data;
			...
			deleteData : function() {
				...
				if (id != '') {
					confirm('确定要删除选中的记录？', function() {
						var url=transUrl("/courseteacher/delete");
						$.ajax({
							type : "POST",
							url : url,
	...
	var validator;
	$(function() {
		var url=transUrl("/courseteacher/list");
